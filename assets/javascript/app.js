...
function createTrivia(){
	...
	},
	{
		...
		info: 'Sir Timothy John Berners-Lee  also known as TimBL, is an English computer scientist, best known as the inventor of the World Wide Web.'
	}
	];
}
...
function count() {
	if (timeRemaining > 0){
		...
		clearInterval(timerInterval);
		newImg();
		$(".winnerSection").prepend('<h1>You waited too long, here is the correct answer.</h1>');
 		//after five seconds reset function is called
...
//add correct answer image and info
function newImg(){
